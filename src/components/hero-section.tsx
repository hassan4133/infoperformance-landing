    ...
    <div className="px-4 -mt-8 relative">
      <div className="flex justify-center">
        ...
        >
          ...
          <div className="px-4 md:px-8 pt-16 pb-20 md:ml-14" style={{ backgroundColor: "rgba(59, 130, 246, 0.01)" }}>
            <div className="flex justify-start pl-4 md:pl-9">
              <div className="max-w-[500px] md:max-w-[600px] lg:max-w-[700px] xl:max-w-[800px]">
                <div className="text-white max-w-full mt-8">
                  ...
                  <div className="flex flex-wrap items-center mb-2">
                    <h1
                      className="text-3xl md:text-5xl lg:text-5xl font-rajdhani font-bold leading-tight text-white"
                    ...
                    <img
                      ...
                      className="h-1 md:h-2 w-auto md:w-[200px] lg:w-[220px] xl:w-[470px] flex-shrink-0 ml-2 md:ml-72"
                    />
                  </div>
